...
const UserSearch = () => {
  ...
  /* store recent search into local storage */
  ...
  const { data, isLoading, isError, error, refetch } = useQuery({
    ...
    // '!!' double bang turns the value into a boolean, because this function is
    // called even though we haven't clicked the submit button
    // we use the "enabled" attribute to control that, so it wont send a GET req when
    // invoked.
    enabled: !!submittedUsername,
  });

  // query to fetch user search
